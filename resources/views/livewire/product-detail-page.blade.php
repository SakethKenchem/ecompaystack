              ...
              <form id="paymentForm" class="bg-white p-8 rounded-lg shadow-md dark:bg-gray-800" x-data="paymentFormData">
                  ...
                  <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" id="product-name" value="{{$product->name}}" readonly class="w-full p-2 mt-2 border rounded-md dark:bg-gray-700 dark:text-gray-300" />
                      </div>
                      <div class="form-group">
                          <label for="first-name" class="block text-gray-700 dark:text-gray-300">First Name</label>
                          <input type="text" value="{{ Auth::user()->name }}" id="first-name" class="w-full p-2 mt-2 border rounded-md dark:bg-gray-700 dark:text-gray-300" />
                      </div>
                      <div class="form-group">
                          <label for="last-name" class="block text-gray-700 dark:text-gray-300">Last Name</label>
                          <input type="text" id="last-name" class="w-full p-2 mt-2 border rounded-md dark:bg-gray-700 dark:text-gray-300" />
                      </div>
                      <div class="form-group">
                          <label for="phone" class="block text-gray-700 dark:text-gray-300">Phone Number</label>
                          <input type="tel" id="phone" class="w-full p-2 mt-2 border rounded-md dark:bg-gray-700 dark:text-gray-300" />
                      </div>
