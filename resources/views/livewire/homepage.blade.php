        ...
        <div class="max-w-2xl text-center mx-auto">
          ...
          <div class="mt-5 max-w-2xl">
            <h1 class="block font-semibold text-gray-800 text-4xl md:text-5xl lg:text-6xl dark:text-neutral-200">
              Ecommerce with Paystack
            </h1>
          </div>
          <!-- End Title -->
  
          <div class="mt-5 max-w-3xl">
            <p class="text-lg text-gray-600 dark:text-neutral-400">Browse products and pay using Paystack!</p>
          </div>
  
          <!-- Buttons -->
          <div class="mt-8 gap-3 flex justify-center">
            <a wire:navigate class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" href="/products-page">
              Browse Products
