                  ...
                  <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3">
                    <div class="border border-gray-300 dark:border-gray-700">
                      <div class="relative bg-gray-200">
                        <a  href="{{ auth()->check() ? '/products-page/'.$product->name : 'login' }}" class="">
                      ...
                      <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">
                        ...
                        <a href="{{ auth()->check() ? '/products-page/'.$product->name : 'login' }}"  class="text-gray-500 flex items-center space-x-2 dark:text-gray-400 hover:text-orange-400 dark:hover:text-red-300">
